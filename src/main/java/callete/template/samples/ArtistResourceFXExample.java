...
/**
 * Example that shows artist images are requested using the echo nest API.
 * The image is displayed in a JavaFX UI afterwards.
 */
public class ArtistResourceFXExample extends Application {
  ...
  public void start(final Stage primaryStage) throws Exception {
    System.out.println("Started ArtistResourceFXExample");
